...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        String temp=getnow();
        temptime=strr.toint(temp);
        cnt=8*9;
        //Log.d("fuck", "onClick: "+temp.substring(3,5));
        //time1.setText("游戏开始!现在是:"+temp);
            ...
            if (isfirst == true) {
                ...
                if (getval(loc) == getval(firstloc)) {
                    ...
                    if (isok(firstloc, loc)) {
                        ...
                        if(isover()){
                            //TextView time1=findViewById(R.id.time1);
                            score=strr.toint(getnow())-temptime;
                            Intent intent=new Intent(MainActivity.this,pop.class);
                            intent.putExtra("score",score);
                            intent.putExtra("level",level);
                            startActivity(intent);
                            //time1.setText("游戏结束!"+strr.tostr(score));
                        }
